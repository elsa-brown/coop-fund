<?php get_header(); ?>
	...
	<article>
		<p><span class="bold">Authorization Sessions 2018</span><br /><br />Throughout the course of the Authorization Sessions exhibition, there will be bi-weekly meetings with the expanded membership of the Coop Fund and interested parties, to further develop the Fund and its constitution. Participants in these meetings will be paid a fee. At the end of the exhibition period we will host two meetings/workshops with other coops and coops-to-be on how to start their own cooperative fund.
		<a name="what-is-a-coop" class="adjust-large"></a>
		</p>
		<br />
		<br />
		...
		<ul>
			...
			<li>equality,</li>
			<li>equity,</li>
			<li>and solidarity.</li>
		</ul>
		In the tradition of their founders, cooperative members believe in the ethical values of honesty, openness, social responsibility, and caring for others.</p>
	</article>
	<a name="how-it-works" class="adjust-large"></a>
	<article>
		<span class="bold">How It Works</span><br /><br />
		<ol class="sans">
			<div class="image-small" id="book"></div>
			<li>Read the Coop Fund Purpose, Principles, Participation documents</li>
			<li>Decide if you want to become a member</li>
			<li>Become a member (link to sign up page)</li>
			<li>Subscribe w/ a minimum of $2 a month (you can increase your subscription if and when you have the means to do so).</li>
			<li>As a member you have access to the discussions and decision making forum on the site Loomio</li>
			<li>Propose projects that you want to have funded</li>
			<li>Vote on other members projects</li>
			<li>Funds are distributed to approved proposals</li>
		</ol>
	</article>
	<a name="definitions" class="adjust-large"></a>
	<article>
